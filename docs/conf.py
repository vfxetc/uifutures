# -*- coding: utf-8 -*-
#
# uifutures documentation build configuration file, created by
...
htmlhelp_basename = 'uifuturesdoc'
...
latex_documents = [
  ('index', 'uifutures.tex', u'uifutures Documentation',
   u'Western X', 'manual'),
]
...
man_pages = [
    ('index', 'uifutures', u'uifutures Documentation',
     [u'Western X'], 1)
]
...
texinfo_documents = [
  ('index', 'uifutures', u'uifutures Documentation',
   u'Western X', 'uifutures', 'One line description of project.',
   'Miscellaneous'),
]
